...
${DOCKER2_CMD} -v \"/etc/localtime:/etc/localtime:ro\" -v \"/dev/input:/dev/input\" --network host --privileged --security-opt seccomp=unconfined nkoenig/subt-virtual-testbed tunnel_circuit_practice.ign worldName:=tunnel_circuit_practice_01 robotName1:=X1 robotConfig1:=X1_SENSOR_CONFIG1
